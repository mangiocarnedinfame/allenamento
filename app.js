...
(function(){
  ...
  // --- Sound engine (beep sintetizzati, nessun file audio esterno necessario)
  let audioCtx = null;
  let masterGain = null;
  let compressor = null;
  function getAudioCtx(){
    if (!audioCtx){
      ...
      // Compressore per alzare il volume percepito senza distorcere
      ...
      // Guadagno master per spingere il volume complessivo
  ...
  function beep(freq, duration, delay = 0, type = 'square'){
